...
cap.set(3,1280)
cap.set(4,960)
left_eye=cv2.imread('FaceFilterDragon/assets/eye1.png')
right_eye=cv2.imread('FaceFilterDragon/assets/eye2.png')
smoke_animation=cv2.VideoCapture('FaceFilterDragon/assets/smoke_animation.mp4')
